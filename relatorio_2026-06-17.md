# Monitor TSE — 17/06/2026

| | |
|---|---|
| Total registradas (cargo=Presidente) | **372** |
| Aprovadas para o agregador | **100** |
| Novas detectadas hoje | **100** |

## 📊 Classificação

| Status | Quantidade | Critério |
|--------|-----------|---------|
| ✅ Aprovada | 100 | n>1.000 + nacional explícito |
| ❌ Excluída — estadual | 174 | nacional ausente + estadual explícito |
