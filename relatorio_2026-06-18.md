# Monitor TSE — 18/06/2026

| | |
|---|---|
| Total registradas (cargo=Presidente) | **374** |
| Aprovadas para o agregador | **101** |
| Novas detectadas hoje | **101** |

## 📊 Classificação

| Status | Quantidade | Critério |
|--------|-----------|---------|
| ✅ Aprovada | 101 | n>1.000 + nacional explícito |
| ❌ Excluída — estadual | 175 | nacional ausente + estadual explícito |
| ⚠️ Inconclusiva | 33 | n>1.000 + sem padrão nos campos |
| ❌ Excluída — amostra | 65 | n ≤ 1.000 |
...
| INSTITUTO SETA DE PESQUISA | 2026-06-15 → 2026-06-17 | 2026-06-20 | 1,500 | `2_EXCLUIDA_ESTADUAL` |
