# Monitor TSE — 05/06/2026

| | |
|---|---|
| Total registradas (cargo=Presidente) | **336** |
| Aprovadas para o agregador | **90** |
| Novas detectadas hoje | **90** |

## 📊 Classificação

| Status | Quantidade | Critério |
|--------|-----------|---------|
| ✅ Aprovada | 90 | n>1.000 + nacional explícito |
| ❌ Excluída — estadual | 159 | nacional ausente + estadual explícito |
| ⚠️ Inconclusiva | 26 | n>1.000 + sem padrão nos campos |
...
|-----------|-------|------------|---------|--------|
| DELTA AGENCIA DE PESQUISA | 2026-06-01 → 2026-06-06 | 2026-06-06 | 1,200 | `1_APROVADA` |
...
| REAL TIME BIG DATA | 29 | 2,052,000 | 70,759 | 40.00 |
